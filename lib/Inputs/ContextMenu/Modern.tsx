...
const StyledMenu = styled('div')({
    '.contextMenuButton':{    fontFamily: "The Sims Sans",
    fontSize: "16px",
    borderRadius: "50px",
    color: "#0949ab",
...
export const ContextMenuModern = () => {
    ...
    return (<StyledMenu><ContextMenu open={open} options={[{item: 'one long name', action: () => {}}, {item: 'two long name', action: () => {}}, 
        {item: 'three', action: () => {}},{item: 'four', action: () => {}},
        {item: 'five', action: () => {}},]} 
