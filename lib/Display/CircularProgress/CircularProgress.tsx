...
import * as Types from "./CircularProgress.types";
const CircularProgress = React.forwardRef<HTMLElement, Types.CircularProgressProps>((props) => {
  const { variant = "modern", size = 120 } = props;
  return (
    <>
      {variant === "modern" ? (
        <Styles.StyledModernSpinner width={size} height={size * 2} viewBox='0 0 24 24'>
          ...
          />
        </Styles.StyledModernSpinner>
      ) : (
        <Styles.StyledOldSpinner width={size} height={size} viewBox='0 0 52 52'>
