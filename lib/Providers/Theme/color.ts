export const colors = {
  ...
  tooltipGradient: "linear-gradient(180deg, #ffffff 20%, #efefef)",
  disabledGradient: "linear-gradient(180deg, #fefefe 20%, #f7f7f7)",
  tooltipBorder: "#b4b4b4",
  disabledText: "#999999",
  darkBlue: "#0949ab",
  lightBlue: "#1e81e0",
  green: "#199c2c",
