 ...
 */
declare function useSlotProps<ElementType extends React.ElementType, SlotProps, AdditionalProps, OwnerState>(parameters: UseSlotPropsParameters<ElementType, SlotProps, object, WithCommonProps<Record<string, any>>, AdditionalProps, OwnerState>): Simplify<OtherProps & {
    ownerState: ElementType_1 extends React.ComponentType<any> ? OwnerState_1 : ElementType_1 extends keyof React.JSX.IntrinsicElements ? undefined : OwnerState_1 | undefined;
}>;
